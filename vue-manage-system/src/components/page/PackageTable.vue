    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="expressNumber" width='165' label="快递单号" align="center"></el-table-column>
                <el-table-column prop='expressCompany' width='115' label='快递公司' align='center'></el-table-column>
                <el-table-column prop="receiverPhone" label="收件人电话" align="center"></el-table-column>
<!--                <el-table-column prop="receiverAddress" label="收件人地址" align="center"></el-table-column>-->
                <el-table-column prop="receiverName" label="收件人" align="center"></el-table-column>
                <el-table-column prop='senderPhone' label='寄件人电话' align='center'></el-table-column>
<!--                <el-table-column prop='senderAddress' label='寄件人地址' align='center'></el-table-column>-->
                <el-table-column prop='senderName' label='寄件人' align='center'></el-table-column>
                <el-table-column prop='expOperatorId' label='操作员ID' width='165' align='center'></el-table-column>
                <el-table-column prop='expOperatorPhone' label='操作员电话' align='center'></el-table-column>
                ...
                <el-table-column label="操作" width="140" align="center" v-if="$store.state.power">
                    <template slot-scope="scope">
                        <el-button
                                type="text"
                                icon="el-icon-edit"
...
<script>
import {ChangePackageInfo, DeletePackageInfo, GetPackageInfo} from '../../api/Package';
...
export default {
        ...
        methods: {
            ...
            getData() {
                GetPackageInfo(this.query).then(res => {
